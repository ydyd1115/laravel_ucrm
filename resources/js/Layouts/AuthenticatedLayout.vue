            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink :href="route('purchases.create')" :active="route().current('customers.index')">
                                    購入画面
                                </NavLink>
                            </div>
                        </div>
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('purchases.create')" :active="route().current('customers.index')">
                            購入画面
                        </ResponsiveNavLink>
                    </div>
